...
resource "aws_network_acl_rule" "public_allow_ssh_egress" {
...
resource "aws_network_acl_rule" "public_allow_egress_dns_udp" {
...
resource "aws_network_acl_rule" "public_allow_egress_dns_tcp" {
  count = var.nacl_allow_all_egress_dns ? 1 : 0
