...
resource "aws_network_acl_rule" "secure_allow_http_ingress" {
...
resource "aws_network_acl_rule" "secure_allow_https_ingress" {
...
resource "aws_network_acl_rule" "secure_allow_ssh_egress" {
